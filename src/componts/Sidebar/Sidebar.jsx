  ...
  return (
    <Box>
      ...
      >
        ...
        {/* Navigation Menu */}
        <List>
          <ListItem button component={Link} to="/dashboard/quotations" sx={{ '&:hover': { backgroundColor: '#333' } }}>
            <ListItemIcon>
          ...
          <Divider />
          <ListItem button component={Link} to="/dashboard/bills" sx={{ '&:hover': { backgroundColor: '#333' } }}>
            <ListItemIcon>
          ...
          <Divider />
          <ListItem button component={Link} to="/dashboard/profile" sx={{ '&:hover': { backgroundColor: '#333' } }}>
            <ListItemIcon>
